...
client.on('messageCreate', async (message) => {
    ...
    if (command === 'معلوماتي') {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                { name: '🗓️ تاريخ إنشاء الحساب:', value: createdValue, inline: false },
                { name: '📥 تاريخ دخول السيرفر:', value: joinedValue, inline: false },
                { name: '⏰ وقت طلب الأمر:', value: timeValue, inline: false }
            )
